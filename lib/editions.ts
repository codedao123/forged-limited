...
export const editions: Edition[] = [
  ...
  {
    number: '0002',
    vehicle: 'Nissan Skyline GT-R R34 V-Spec',
    ownerInstagram: '@midnight.spec',
    featuredDate: 'February 2026',
    location: 'Osaka, Japan',
    year: '1999',
    power: '280 hp — RB26DETT twin-turbo',
    modifications: [
      'Factory-original, unmodified drivetrain',
      'NISMO-spec suspension refresh',
      'Preserved Bayside Blue paintwork',
      'Under 9,000 km from new',
    ],
    gallery: ['/editions/0002.png', '/editions/0002-a.png', '/editions/0002-b.png'],
    story:
      'Bayside Blue, preserved rather than modified. A car that has covered fewer than nine thousand kilometres and lives beneath a cover in a climate-controlled space. A study in restraint.',
  },
  {
    number: '0003',
